...
const PastSpeakersCarouselC = () => {
    return (
        <div className="grid grid-cols-5 grid-rows-1 overflow-x-auto bg-WAccentColor py-4">
                ...
                <div className="place-self-center self-center z-40 col-start-5 row-start-1 col-span-1 row-span-full row-start-2 bg-WAccentColor rounded-full flex items-center justify-center size-10 cursor-pointer drop-shadow-lg">
