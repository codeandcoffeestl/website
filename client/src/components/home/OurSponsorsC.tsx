  ...
  return (
    ...
    <div className="card relative bg-cover bg-center bg-coffeeBgImg">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center pt-10 pb-5 mb-3">
        ...
        <button className="z-10 text-lg bg-OHighlightColor text-PrimaryColor shadow-lg hover:text-PrimaryColor hover:border hover:border-OHighlightColor hover:font-bold md:mt-0">
          Become A Sponsor
        </button>
      </div>
